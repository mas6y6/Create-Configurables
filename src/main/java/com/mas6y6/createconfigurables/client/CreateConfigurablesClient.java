...
public class CreateConfigurablesClient {
    public static final String MODID = "createconfigurables";
    public static final Logger LOGGER = LoggerFactory.getLogger(MODID);
    public static CreateConfigurablesClient instance;

    public CreateConfigurablesClient(IEventBus modEventBus) {
        instance = this;
        NeoForge.EVENT_BUS.register(this);
    }

    public static CreateConfigurablesClient getInstance() {
        return instance;
    }
