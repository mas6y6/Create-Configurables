...
import com.mas6y6.createconfigurables.common.packets.ServerBoundGetCrushingConflictingRecipesPacket;
import com.mas6y6.createconfigurables.common.packets.ServerBoundGetCrushingWheelConfigPacket;
import com.mas6y6.createconfigurables.common.packets.ServerBoundSetConfigurationPacket;
...
public class ConfigureCrushingWheelScreenMain extends Screen {
    ...
    protected void init() {
        ...
        this.resetButton = new TextureButton(this.leftPos + 136, this.topPos + 151, 18, 18, ResourceLocation.parse("createconfigurables:textures/gui/buttons.png"), (button) -> {
            PacketDistributor.sendToServer(new ServerBoundSetConfigurationPacket(new CrushingWheelsConfig(Map.of(), controller_uuid)));
        ...
        PacketDistributor.sendToServer(new ServerBoundGetCrushingConflictingRecipesPacket());
        PacketDistributor.sendToServer(new ServerBoundGetCrushingWheelConfigPacket(controller_uuid));
