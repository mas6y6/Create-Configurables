...
import com.mas6y6.createconfigurables.common.packets.ServerBoundGetItemDrainConflictingRecipesPacket;
import com.mas6y6.createconfigurables.common.packets.ServerBoundGetItemDrainConfigPacket;
...
public class ConfigureItemDrainScreenMain extends Screen {
    private static final ResourceLocation BACKGROUND = ResourceLocation.fromNamespaceAndPath(CreateConfigurables.MODID, "textures/gui/configure_crushing_wheels.png");
    ...
    public ConfigureItemDrainScreenMain(String controller_uuid) {
        super(TITLE);
    ...
    protected void init() {
        ...
        scrollList.setOnSelectEntry((ctx) -> {
            Minecraft.getInstance().setScreen(new ConfigureItemDrainScreenRecipe(controller_uuid.toString(), (net.minecraft.world.item.ItemStack) ctx.entry().items().getFirst(), recipeConflicts, config));
        });
        ...
        this.resetButton = new TextureButton(this.leftPos + 136, this.topPos + 151, 18, 18, ResourceLocation.parse("createconfigurables:textures/gui/buttons.png"), (button) -> {
            PacketDistributor.sendToServer(new ServerBoundSetItemDrainConfigurationPacket(new ItemDrainConfig(Map.of(), controller_uuid)));
        ...
        PacketDistributor.sendToServer(new ServerBoundGetItemDrainConflictingRecipesPacket());
        PacketDistributor.sendToServer(new ServerBoundGetItemDrainConfigPacket(controller_uuid));
